...
public final class Constants {
  ...
  public static class RobotMode {
    private static final RobotType ROBOT = RobotType.ROBOT_2025_HOLO;
    ...
    public static RobotType getRobot() {
      ...
      if (ROBOT != RobotType.ROBOT_2024_RETIRED_MAESTRO && ROBOT != RobotType.ROBOT_2025_HOLO) {
        invalidRobotAlert.set(true);
        return RobotType.ROBOT_2025_HOLO;
      }
    ...
    public enum RobotType {
      ...
      ROBOT_2025_HOLO(RobotConfig2025::new);
  ...
  public static class RobotDimensions {
    public static Distance BUMPER_THICKNESS = Units.Inches.of(4.1);
  ...
  public static class IntakeConstants { // TODO: check all constants for new season
    ...
    public static class PivotConstants {
      ...
      public static final Rotation2d HOME_POSITION = Rotation2d.fromDegrees(124.19);
      ...
      public static final Rotation2d ALGAE_SCORE_ANGLE = Rotation2d.fromDegrees(45);
